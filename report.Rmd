...
var_cc_l1 <- c("feess_ga", "feess_si", "soc_relatedness","soc_positivity", "sar_victim", "sar_perpetrator") #c("feess_si", "LM_in","Friend_in", "sar_victim", "sar_perpetrator")
...
Q1: Is there a general factor that could be derived from various aspects (ie perceived social inclusion; sociometric position; bullying involvement) of students peer-relations within the classroom? 
